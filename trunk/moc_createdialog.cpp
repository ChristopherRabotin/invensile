...
const QMetaObject CreateDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateDialog,
      qt_meta_data_CreateDialog, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CreateDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CreateDialog))
