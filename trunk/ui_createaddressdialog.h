...
public:
    ...
    void setupUi(QDialog *CreateAddressDialog)
    {
        ...
        previousButton = new QPushButton(CreateAddressDialog);
        previousButton->setObjectName(QString::fromUtf8("previousButton"));

        horizontalLayout_10->addWidget(previousButton);

        nextButton = new QPushButton(CreateAddressDialog);
        ...
        QWidget::setTabOrder(buttonBox, nextButton);
    ...
    void retranslateUi(QDialog *CreateAddressDialog)
    {
        ...
        previousButton->setText(QApplication::translate("CreateAddressDialog", "Previous addess", 0, QApplication::UnicodeUTF8));
        nextButton->setText(QApplication::translate("CreateAddressDialog", "Next address", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
