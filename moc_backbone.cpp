...
static const char qt_meta_stringdata_backbone[] = {
    "backbone\0"
};

const QMetaObject backbone::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_backbone,
      qt_meta_data_backbone, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &backbone::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_backbone))
